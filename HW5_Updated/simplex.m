...
%
function [xstar,optobj,optbasis,nonbasis0,nonbasisu,totaliters,raystar,ystar,wstar,zstar]=simplex(A,b,c,u,const,maxiters,printlevel)
...
if n>old_n
    [xstar,optobj,optbasis,nonbasis0,nonbasisu,totaliters,raystar,ystar,wstar,zstar] = phase_1(A,b,c,u,0,basis,nonbasis0,nonbasisu,epsilon2)
...
% Starting Phase II
[xstar,optobj,optbasis,nonbasis0,nonbasisu,totaliters,raystar,ystar,wstar,zstar] = phase_2(A,b,c,u,const,basis,nonbasis0,nonbasisu,epsilon2)  

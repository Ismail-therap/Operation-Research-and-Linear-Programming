function [xstar,optobj,optbasis,nonbasis0,nonbasisu,totaliters,ray,ystar,wstar,zstar] = phase_2(A,b,c,u,const,basis,nonbasis0,nonbasisu,epsilon2)
...
while min(rn0) <-epsilon2 | max(rnu) > -epsilon2
        ...
        if leavingvar==0 && tlimit==+Inf
            fprintf('LP is unbounded at phase II');
                ...
                nonbasisu=nonbasisu;
                totaliters=Iteration+Iteration2; %total phase I and phase II iterations.
                t=enteringvar;
                ray=zeros(n,1);
                ray1=rref(A);
                ray(t)=1;
